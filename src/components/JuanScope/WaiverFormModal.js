    ...
    <
      ...
      <
        ...
        div className="modal-section" >
                <
        div style={
                    { fontWeight: 'bold', fontSize: '14px', marginBottom: '0.5rem' }} >
        ...
        h4 > Reason: < /h4> <
        /div> <
                                        textarea value={waiverData.reason}
                                      ...
                                      /> <
        div style={
                                          { fontSize: '10px', color: '#666', marginTop: '0.2rem' }} > {waiverData.reason.length}
                                        /250 characters <
        /div> {
                                          errors.reason && (<
        ...
        /label> <
                                                          DatePicker selected={waiverData.promiseDate}
        ...
        div className="scope-modal-buttons" >
                                                              <
        button className="scope-modal-cancel"
                                                                onClick={onClose} >
                                                                Cancel <
        /button> <
        button className="scope-modal-confirm"
